/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 52eb186baa8191b8d9dfdd31afafe172)
// Runtime types generated with workerd@1.20260219.0 2026-02-19 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DigestCoordinator";
	}
	interface Env {
		TIMELINE_DB: D1Database;
		DIGEST_EMAIL: SendEmail;
		BROWSER: Fetcher;
		ASSETS: Fetcher;
		DIGEST_TOPICS: "software development, cloud services, devtools, startups, open source, AI-assisted development, engineering management, indie hackers, operating systems, distributed systems";
		TIMELINE_URL: "https://x.com/home?f=following";
		TARGET_TWEET_COUNT: "70";
		SCROLL_PASSES: "7";
		OPENAI_MODEL: "gpt-4.1-mini";
		DIGEST_TIMEZONE: "UTC";
		BACKFILL_TARGET_TWEET_COUNT: "700";
		BACKFILL_SCROLL_PASSES: "140";
		PERSIST_DRY_RUN: "0";
		SCHEDULED_DRY_RUN: "0";
		DIGEST_SENDER: "digest@example.com";
		DIGEST_RECIPIENT: "digest@example.com";
		OPENAI_API_KEY: string;
		ADMIN_TOKEN: string;
		DIGEST_COORDINATOR: DurableObjectNamespace<import("./src/index").DigestCoordinator>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIGEST_TOPICS" | "TIMELINE_URL" | "TARGET_TWEET_COUNT" | "SCROLL_PASSES" | "OPENAI_MODEL" | "DIGEST_TIMEZONE" | "BACKFILL_TARGET_TWEET_COUNT" | "BACKFILL_SCROLL_PASSES" | "PERSIST_DRY_RUN" | "SCHEDULED_DRY_RUN" | "DIGEST_SENDER" | "DIGEST_RECIPIENT" | "OPENAI_API_KEY" | "ADMIN_TOKEN">> {}
}
